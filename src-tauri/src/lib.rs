...
mod backend;
use crate::backend::{SharedState, AppState, check_count, increment_count, system_info, start_macro, pause_macro, resume_macro, stop_macro};
mod utils;
...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![check_count, increment_count, system_info, start_macro, pause_macro, resume_macro, stop_macro])
